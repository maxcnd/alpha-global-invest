...
const translations = {
  en: {
    ...
    'success.title': 'Thank you for your inquiry',
    'success.text': 'Your message has been received. We will contact you personally within two business days.',
    'success.button': 'Return to Homepage',
    // Footer
    ...
    'monthly.title': 'Monthly Investment Report',
    'monthly.text': 'Latest end-of-month update with portfolio returns, asset allocation and currency exposure.',
    'monthly.button': 'Download April 2026 Report',
  ...
  de: {
    ...
    'success.title': 'Vielen Dank für Ihre Anfrage',
    'success.text': 'Ihre Nachricht ist bei uns eingegangen. Wir melden uns persönlich innerhalb von zwei Werktagen.',
    'success.button': 'Zur Startseite',
    // Footer
    ...
    'monthly.title': 'Monatlicher Investmentbericht',
    'monthly.text': 'Aktuelles Monatsende-Update mit Portfoliorenditen, Vermögensallokation und Währungsexposure.',
    'monthly.button': 'Bericht April 2026 herunterladen',
    // Call to action for appointment
  ...
  it: {
    ...
    'success.title': 'Grazie per la sua richiesta',
    'success.text': 'Il suo messaggio è stato ricevuto. La contatteremo personalmente entro due giorni lavorativi.',
    'success.button': 'Torna alla homepage',
    // Footer
    ...
    'monthly.title': 'Rapporto mensile di investimento',
    'monthly.text': 'Aggiornamento di fine mese con rendimenti del portafoglio, allocazione degli attivi ed esposizione valutaria.',
    'monthly.button': 'Scarica il rapporto di aprile 2026',
  ...
  fr: {
    ...
    'success.title': 'Merci pour votre demande',
    'success.text': 'Votre message nous est parvenu. Nous vous contacterons personnellement sous deux jours ouvrés.',
    'success.button': 'Retour à l’accueil',
    // Footer
    ...
    'monthly.title': 'Rapport mensuel d’investissement',
    'monthly.text': 'Mise à jour de fin de mois avec les rendements du portefeuille, l’allocation d’actifs et l’exposition aux devises.',
    'monthly.button': 'Télécharger le rapport d’avril 2026',
